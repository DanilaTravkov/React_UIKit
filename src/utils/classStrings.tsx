const primaryButtonStyles = "border-2 border-slate-500 m-4 text-white font-normal py-3 px-4 rounded-2xl bg-transparent hover:bg-zinc-500/10 transition";
const secondaryButtonStyles = "border-2 border-slate-500 m-4 text-white font-thin py-2 px-4 rounded-2xl bg-transparent hover:bg-zinc-500/10 transition";
const disabledButtonStyles = "border-2 border-slate-500 m-4 bg-teal-800/60 text-white/60  hover:cursor-not-allowed hover:border-none";
...
const optionStyles = "rounded-xl text-start p-2 bg-transparent text-white cursor-pointer transition hover:bg-zinc-500/10";
